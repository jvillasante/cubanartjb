...
'float delim' => '.', 'at-time' => ' a', 'AM' => 'AM', 'PM' => 'PM',
...
'full months'   => array('Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo',
'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre',
'Noviembre', 'Diciembre'),
'short months'  => array('Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul',
'Ago', 'Sep', 'Oct', 'Nov', 'Dec'),

'full days'     => array('Domingo', 'Lunes', 'Martes', 'Miércoles', 'Jueves',
'Viernes', 'Sábado'),
'short days'    => array('Dom', 'Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sav'),
...
// 12s, 3 min, 2 years, ...
// number string: array('stem', 0, 1, 2-4, 5-20)
'AGO s' => array(' segundo', 's', '', 's', 's'), 'AGO short s' => 's',
'AGO i' => array(' minuto', 's', '', 's', 's'), 'AGO short i' => 'min',
'AGO h' => array(' hora', 's', '', 's', 's'),   'AGO short h' => 'h',
'AGO d' => array(' día', 's', '', 's', 's'),    'AGO short d' => 'd',
'AGO o' => array(' mes', 's', '', 's', 's'),  'AGO short o' => 'mes',
'AGO w' => array(' semana', 's', '', 's', 's'),   'AGO short w' => 'w',
'AGO y' => array(' año', 's', '', 's', 's'),   'AGO short y' => 'y',

// number - distance in days.
'AGO b0' => 'hoy', 'AGO short b0' => 'hoy',
'AGO b1' => 'ayer', 'AGO short b1' => 'ayer',
'AGO b2' => 'antes de ayer', 'AGO short b2' => 'anteayer',

'AGO future b0' => 'hoy más tarde', 'AGO future short b0' => 'hoy',
'AGO future b1' => 'mañana', 'AGO future short b1' => 'mañana',
'AGO future b2' => 'día después de mañana', 'AGO future short b2' => 'día después',
